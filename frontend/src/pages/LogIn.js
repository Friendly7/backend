        ...
        <div className="container_lg_t">
          ...
          <div id='login'>
            ...
            <div id='join_choose'>
              ...
              <button onClick={() => navigate('/JoinMento')} id='join_choose_btn'>멘티 / 내담자용 <br/>회원가입</button>
              <button onClick={() => navigate('/JoinMenti')} id='join_choose_btn'>멘토 / 상담사용 <br/>회원가입</button>
            </div>
          </div>
        </div>
      </div>
